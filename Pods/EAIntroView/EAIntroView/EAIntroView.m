...
- (void)scrollViewDidScroll:(EARestrictedScrollView *)scrollView {
    ...
    CGFloat offset1 = scrollView.contentOffset.x / self.scrollView.frame.size.width;
    NSUInteger page1 = (NSUInteger)(offset1);
    
    if (page1 == 0) {
        self.sign1View.alpha = 1 - offset1 + page1;
        self.sign2View.alpha = offset1 - page1;
    } else if (page1 == 1) {
        self.sign2View.alpha = 1 - offset1 + page1;
        self.sign3View.alpha = offset1 - page1;
    } else {
        self.sign3View.alpha = 1 - offset1 + page1;
        self.sign4View.alpha = offset1 - page1;
    }
}
...
- (void) signup {
    ...
    [SlideNavigationController sharedInstance].isLogin = NO;
    [SlideNavigationController sharedInstance].isInit = YES;
...
- (void) login {
    ...
    [SlideNavigationController sharedInstance].isLogin = YES;
    [SlideNavigationController sharedInstance].isInit = YES;
    [[SlideNavigationController sharedInstance] popToRootAndSwitchToViewController:vc withSlideOutAnimation:NO andCompletion:nil];
...
- (void)showInView:(UIView *)view animateDuration:(CGFloat)duration withInitialPageIndex:(NSUInteger)initialPageIndex {
    ...
    // add Exit Button
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(280, 30, 18, 18)];
    [button setBackgroundImage:[UIImage imageNamed:@"icon-exit.png"] forState:UIControlStateNormal];
    [button addTarget:self action:@selector(skipIntroduction) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:button];
    
    // add Sign BUttons
    UIButton *button1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/2, 45)];
    UIButton *button2 = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 0, self.frame.size.width/2, 45)];
    UIButton *button3 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/2, 45)];
    UIButton *button4 = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 0, self.frame.size.width/2, 45)];
    UIButton *button5 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/2, 45)];
    UIButton *button6 = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 0, self.frame.size.width/2, 45)];
    
    [button1 setTitle:@"Sign Up" forState:UIControlStateNormal];
    [button2 setTitle:@"Log In" forState:UIControlStateNormal];
    ...
    [button3 setTitle:@"Sign Up" forState:UIControlStateNormal];
    [button4 setTitle:@"Log In" forState:UIControlStateNormal];
    [button3.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [button4.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [button3 addTarget:self action:@selector(signup) forControlEvents:UIControlEventTouchUpInside];
    [button4 addTarget:self action:@selector(login) forControlEvents:UIControlEventTouchUpInside];
    [button5 setTitle:@"Sign Up" forState:UIControlStateNormal];
    [button6 setTitle:@"Log In" forState:UIControlStateNormal];
    [button5.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [button6.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [button5 addTarget:self action:@selector(signup) forControlEvents:UIControlEventTouchUpInside];
    [button6 addTarget:self action:@selector(login) forControlEvents:UIControlEventTouchUpInside];
    
    // sign1 View
    self.sign1View = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-45, self.frame.size.width, 45)];
    [self.sign1View setBackgroundColor:[UIColor colorWithRed:1.0 green:90.0/255.0 blue:95.0/255.0 alpha:1.0]];
    UIView *sep1View = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 8, 1, 45-16)];
    [sep1View setBackgroundColor:[UIColor colorWithRed:191.0/255.0 green:67.0/255.0 blue:71.0/255.0 alpha:1.0]];
    
    [self.sign1View addSubview:button1];
    [self.sign1View addSubview:button2];
    [self.sign1View addSubview:sep1View];

    // sign2 View
    self.sign2View = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-45, self.frame.size.width, 45)];
    [self.sign2View setBackgroundColor:[UIColor colorWithRed:1.0 green:180.0/255.0 blue:0.0/255.0 alpha:1.0]];
    UIView *sep2View = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 8, 1, 45-16)];
    [sep2View setBackgroundColor:[UIColor colorWithRed:191.0/255.0 green:135.0/255.0 blue:0/255.0 alpha:1.0]];
    
    [self.sign2View addSubview:button3];
    [self.sign2View addSubview:button4];
    [self.sign2View addSubview:sep2View];

    // sign3 View
    self.sign3View = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-45, self.frame.size.width, 45)];
    [self.sign3View setBackgroundColor:[UIColor colorWithRed:0.0 green:122.0/255.0 blue:135.0/255.0 alpha:1.0]];
    UIView *sep3View = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 8, 1, 45-16)];
    [sep3View setBackgroundColor:[UIColor colorWithRed:0.0/255.0 green:91.0/255.0 blue:101.0/255.0 alpha:1.0]];
    
    [self.sign3View addSubview:button5];
    [self.sign3View addSubview:button6];
    [self.sign3View addSubview:sep3View];

    //
    self.sign2View.alpha = 0.0f;
    self.sign3View.alpha = 0.0f;
    self.sign4View.alpha = 0.0f;
    [self addSubview:self.sign1View];
    [self addSubview:self.sign2View];
    [self addSubview:self.sign3View];
