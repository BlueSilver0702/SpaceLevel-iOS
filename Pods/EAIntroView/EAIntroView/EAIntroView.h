...
// Bottom Skip Button Views;
@property (nonatomic, strong) UIView *sign1View;
@property (nonatomic, strong) UIView *sign2View;
@property (nonatomic, strong) UIView *sign3View;
@property (nonatomic, strong) UIView *sign4View;
// Background image
